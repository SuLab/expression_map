...
allen.data <- readRDS('results/allen/pca/allen_50_dim_noDropouts_filtered_irlba.RDS')
...
saveRDS(tsne.out,file='results/allen/tsne/allen_tsne_filtered_noDropouts.RDS')
