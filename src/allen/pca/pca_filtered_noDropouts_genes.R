...
var.genes <- readRDS('results/allen/variable_genes_noDropouts.RDS')
...
saveRDS(gene.pca,'results/allen/pca/allen_proj_filtered_irlba_noDropouts.RDS')
...
saveRDS(corr.gene.dat,'results/allen/pca/allen_50_dim_noDropouts_filtered_irlba.RDS')
