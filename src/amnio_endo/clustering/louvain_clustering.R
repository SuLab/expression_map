...
allen.pca <- readRDS('results/amnio_endo/pca/recount_noAmnio_50_dim_irlba.RDS') 

## neighbors <- nn2(allen.pca,k=30)
neighbors <- nn2(allen.pca,k=30,treetype='bd',searchtype='priority',eps=0.1)
...
saveRDS(allen.louvain,'results/amnio_endo/clustering/louvain_pca_noAmnio_k30.RDS')
